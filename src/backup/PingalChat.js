...
const MIN_INPUT_TOOLBAR_HEIGHT = 100;
const MIN_TOPBAR_HEIGHT = 33;

class PingalChat extends Component {
  constructor(props) {
    super(props);
  ...
  onType(e) {
    ...
    const newSlidesContainerHeight = this.getMaxHeight() - this.calculateInputToolbarHeight(newComposerHeight) - this.getKeyboardHeight();
...
PingalChat.childContextTypes = {
  actionSheet: PropTypes.func,
  getLocale: PropTypes.func,
};

PingalChat.defaultProps = {
