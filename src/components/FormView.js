...
export default class FormView extends React.Component{
  ...
  render(){
    ...
    const validateFirstNameForNumbers = (value)=>{
            /*
    ...
    const validateFirstNameForFour = (value)=>{
            ///Initial state is null/undefined
            if(!value) return true;
    ...
    return (
      ...
      <Form
        ...
        <InputField
          ...
          helpText={helpTextFirstName(this)}
          validationFunction={[ validateFirstNameForNumbers, validateFirstNameForFour ]}
          />
